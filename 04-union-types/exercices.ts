...
// 1. Implement a generic taking two union types and excluding one from the other
namespace one {
  type Exclude<a, b> = TODO;
...
// 3. TODO: Union of literals to union of structure
namespace three {}

...
namespace strings {
  ...
  function expectA<P extends "a">(param: P) {
    return param;
  }
...
namespace unions {
   ...
   */
  function expectAOrB<input extends "a" | "b">(param: input) {
    return param;
  }
...
namespace functions {
  namespace one {
    type ExpectFunctionReturningAString<
      F extends (...params: any[]) => string
    > = F;
  ...
  namespace two {
    type ExpectFunctionTakingAString<F extends (str: string) => any> = F;
  ...
  namespace three {
    type ExpectFunctionReturningACar<F extends (...params: any[]) => Car> = F;
